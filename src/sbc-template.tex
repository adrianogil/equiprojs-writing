...
\subsection{Mapeamento de Imagens Equiretangulares em uma Esfera}
...
\subsection{Visualização em um Skybox}
...
Equivale a discretização da abordagem de mapeamento contínuo das coordenadas de UV em um Skybox.
