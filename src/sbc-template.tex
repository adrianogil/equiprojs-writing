...
Aqui $n$ representa o \textit{bit depth} de um pixel e o MSE, o mínimo erro quadrático (Mean Square Error), é calculado:
...
A arquitetura da nossa implementação envolve uma camada de configuração em C\# na Unity e uma camada em python para o cálculo das métricas nas imagens geradas pela Unity. Abaixo segue o modelo de arquitetura da ferramenta:


\section{Resultados}  \label{sec:results}

% Ferramenta implementada
Utilizamos a \textit{Unity 2017.3.1f} e \textit{python 2.7} para realizar a implementação da ferramenta proposta. 
